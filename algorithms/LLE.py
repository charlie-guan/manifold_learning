...
def fit_transform(X_highdimensional, n_neighbors=5, components=2):
    '''
    ...
    '''
    lle = manifold.LocallyLinearEmbedding(n_neighbors, n_components=components, method='standard', eigen_solver='dense')
    t0 = time()
